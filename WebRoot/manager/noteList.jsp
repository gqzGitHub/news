	...
	<head>
		...
		<script type="text/javascript">
			...
			function deleteNote(id) {
				$.post("NewsList?op=delNote", //请求的URL地址
				{
					noteId : id
				}, //向服务器提交的数据
					...
					<form name="myform" id="myform" method="post">
						...
						<div class="result-content">
							<table class="result-tab" width="100%">
								...
								<tbody>
									<c:forEach items="${page.records }" var="note" varStatus="status">
										<tr>
											<td class="tc">
												<input name="id[]" value="${note.newsId }" type="checkbox">
											</td>
											<td>
												${status.index+1 }
											</td>
											...
											<td>
												<a class="link-del"	href="javascript:deleteNote(${note.noteId })">删除</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
		...
		<div class="footer ">
			<div>
				<p class="padding-bottom">
					...
					<a href="http://runoob.com/" target="_blank"> ForFuture
						Military </a>
					</span>军事新闻网 版权所有
					<br />
					<br />
					<a id="ganquanzhong" href="http://baidu.com/" target="_blank">
						甘全中 </a> mike zhong 湖北理工学院腾龙公寓
				</p>
			</div>
		</div>
		<!--底部版权信息 end-->
