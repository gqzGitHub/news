			...
			<div class="main-wrap">
				...
				<div class="crumb-wrap">
					<div class="crumb-list"><i class="icon-font"></i>
						...
						<a class="crumb-name" href="/jscss/admin/design/">新闻分类管理</a><span class="crumb-step">&gt;</span><span>新闻分类修改</span></div>
				</div>
				<div class="result-wrap">
					<div class="result-content">
						<form action="Back?op=editNewsClass&classId=${newsclass.classId}" method="post" id="myform" name="myform">
							<table class="insert-tab" width="100%">
								<tbody>
									...
									<tr>
										<th><i class="require-red">*</i>修改新闻分类名称：</th>
										<td>
