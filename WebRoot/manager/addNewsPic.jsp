...
<html>
	...
	<head>
		...
		<title>ForFuture News新闻网站后台管理</title>
			...
			<div class="main-wrap">
				...
				<div class="crumb-wrap">
					<div class="crumb-list"><i class="icon-font"></i>
						...
						<a class="crumb-name" href="/jscss/admin/design/">新闻管理</a><span class="crumb-step">&gt;</span><span>添加新闻图片</span></div>
				</div>
							...
							<table class="insert-tab" width="100%">
								<tbody>
									<tr>
										...
										<td><input name="pictures" type="file">
