		...
		<div class="container">
			...
			<nav id="main-navigation" class="clearfix">
				<ul>
					...
					<li><a href="Front?op=getNetnewsList" class="current">全网新闻</a></li>
				</ul>
			</nav>
			<!-- End Main-Navigation -->
			<!---导航 end---->
			...
			<div class="copyrights">
				Collect from <a href="index.jsp">test</a>
			</div>
			...
			<div class="row-fluid">
				...
				<div id="main" class="span8 image-preloader">
					...
					<div class="row-fluid">
						<!-- 新闻列表 start -->
						<div id="NewsList">
									<form name="form-search" method="post"	action="queryNetnews"	class="form-search pull-right">
										<input type="text" name="query" required="required" placeholder="网络新闻爬取...." class="input-icon " /> 
										<input type="submit"name="Search" value="获取" alt="Search" id="searchbutton" title="获取" />
									</form>
				                   <h3 style="color:#f15620;font-weight:500;">全网新闻列表：</h3>
				                   <hr />
				                   <c:forEach items="${page.records }" var="news">
				                   		<a href="${news.url }">
				                    		<h4 style="color:#f15620;font-weight:normal;">${news.title }</h4>
				                    	</a>
				                    	<p> ${news.intro} </p>
				                    	<div style="float:right">
					                    	新闻来源：<span style="color:#f15620"> ${news.media} </span>
					                    	<span style="margin-left:5px;"> ${news.datetime} </span>
				                    	</div>
				                  		<br />
				                  		<hr />
				                  </c:forEach> 
